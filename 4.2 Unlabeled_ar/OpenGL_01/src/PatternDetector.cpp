...
void PatternDetector::buildPatternFromImage(const cv::Mat& image, Pattern& pattern) const
{
	...
	pattern.points3d[0] = cv::Point3f(-100, -60, 0);
	pattern.points3d[1] = cv::Point3f(100, -60, 0);
	pattern.points3d[2] = cv::Point3f(100, 60, 0);
	pattern.points3d[3] = cv::Point3f(-100, 60, 0);
